from plaidrl.envs.pearl_envs.ant_dir import AntDirEnv
from plaidrl.envs.pearl_envs.ant_goal import AntGoalEnv
from plaidrl.envs.pearl_envs.ant_normal import AntNormal
from plaidrl.envs.pearl_envs.half_cheetah_dir import HalfCheetahDirEnv
from plaidrl.envs.pearl_envs.half_cheetah_vel import HalfCheetahVelEnv
from plaidrl.envs.pearl_envs.hopper_rand_params_wrapper import (
    HopperRandParamsWrappedEnv,
)
from plaidrl.envs.pearl_envs.humanoid_dir import HumanoidDirEnv
from plaidrl.envs.pearl_envs.point_robot import PointEnv, SparsePointEnv
from plaidrl.envs.pearl_envs.rand_param_envs.walker2d_rand_params import (
    Walker2DRandParamsEnv,
)
from plaidrl.envs.pearl_envs.walker_rand_params_wrapper import (
...
#         importlib.import_module('plaidrl.envs.pearl_envs.' + module)

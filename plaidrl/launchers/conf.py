...
plaidrl_project_dir = join(os.path.dirname(plaidrl.__file__), os.pardir)
LOCAL_LOG_DIR = join(plaidrl_project_dir, "data")
...
RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    join(plaidrl_project_dir, "scripts", "run_experiment_from_doodad.py")
    # '/home/user/path/to/plaidrl/scripts/run_experiment_from_doodad.py'
)
"""
AWS Settings
"""
...
SSS_RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    "/global/home/users/USERNAME/path/to/plaidrl/scripts"
...
try:
    from plaidrl.launchers.conf_private import *
except ImportError:

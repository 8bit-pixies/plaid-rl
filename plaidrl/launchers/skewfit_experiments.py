...
from plaidrl.envs.vae_wrapper import temporary_mode
from plaidrl.samplers.data_collector.vae_env import VAEWrappedEnvPathCollector
from plaidrl.torch.her.her import HERTrainer
from plaidrl.torch.sac.policies import MakeDeterministic
from plaidrl.torch.sac.sac import SACTrainer
from plaidrl.torch.skewfit.online_vae_algorithm import OnlineVaeAlgorithm
from plaidrl.util.io import load_local_or_remote_file
from plaidrl.util.video import dump_video
...
def train_vae(variant, return_data=False):
    ...
    import plaidrl.torch.vae.conv_vae as conv_vae
    from plaidrl.core import logger
    from plaidrl.pythonplusplus import identity
    from plaidrl.torch.vae.conv_vae import ConvVAE
    from plaidrl.torch.vae.vae_trainer import ConvVAETrainer
    from plaidrl.util.ml_util import PiecewiseLinearSchedule
...
def get_envs(variant):
    ...
    from plaidrl.envs.vae_wrapper import VAEWrappedEnv
    from plaidrl.util.io import load_local_or_remote_file
...
def get_exploration_strategy(variant, env):
    ...
    from plaidrl.exploration_strategies.gaussian_strategy import GaussianStrategy
    from plaidrl.exploration_strategies.ou_strategy import OUStrategy
...
def skewfit_experiment(variant):
    import plaidrl.torch.pytorch_util as ptu
    from plaidrl.data_management.online_vae_replay_buffer import (
        OnlineVaeRelabelingBuffer,
    )
    from plaidrl.torch.networks import ConcatMlp
    from plaidrl.torch.sac.policies import TanhGaussianPolicy
    from plaidrl.torch.vae.vae_trainer import ConvVAETrainer

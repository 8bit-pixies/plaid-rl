...
import plaidrl.pythonplusplus as ppp
from plaidrl.core import logger
from plaidrl.launchers import conf
from plaidrl.torch.pytorch_util import set_gpu_mode
...
def run_experiment(
    ...
    :param use_gpu:
    :param snapshot_mode: See plaidrl.core.logging
    :param snapshot_gap: See plaidrl.core.logging
    ...
    if mode == "local":
        ...
        dmode = doodad.mode.EC2AutoconfigDocker(
            ...
            # will start just making the sub-directories within plaidrl rather
